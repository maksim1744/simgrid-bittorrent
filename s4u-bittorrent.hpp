 ...
 */
constexpr unsigned long FILE_PIECES   = 300UL;
...
public:
  ...
  std::bitset<FILE_PIECES> bitfield = 0U;
  int piece             = 0;
  int block_index       = 0;
  int block_length      = 0;
  ...
  Message(MessageType type, int peer_id, std::bitset<FILE_PIECES> bitfield, simgrid::s4u::Mailbox* return_mailbox)
